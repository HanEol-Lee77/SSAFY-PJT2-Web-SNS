...
<div id="catProfile" class="page">
    ...
    <div class="profileView">
        <div class="leftPart" v-if="(selectedCat != null)">
            <img id="catPhoto" :src='require(`@/assets/images/cat/${ selectedCat.cat_image }`)' alt="catProfile">
            <!-- <img id="catPhoto" :src='`/static/images/cat/${ selectedCat.cat_image}`' alt="catProfile"> -->
        </div>
